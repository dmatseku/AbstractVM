...
add sub mul div mod 
\[\*type\*(n)\]     | Unstacks the first two values on the stack or unstacks the first value on the stack and next one from argument, adds / subtracts / multiplies / divides / calculates the modulus, then stacks the result.
